...
class EditorTextSelectionOverlay {
  ...
  /// Computes the text direction once from the first strongly-directional
  /// character in the selected text. Both handles share the same result.
