...
///
/// - Mobile: تعرض [ArchiveScreen] كما هي
...
class _ArchiveScreenResponsiveState extends State<ArchiveScreenResponsive>
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      try {
        Provider.of<SelectedNoteProvider>(
          navigatorKey.currentContext ?? _lastContext!,
          listen: false,
        ).clearSelection();
      } catch (_) {}
    });
  ...
  // حفظ context آخر لاستخدامه في dispose
  ...
  void _restoreSelected() async {
    ...
    UnifiedNotificationService().showWithUndo(
      ...
      onExecute: () {},
      onUndo: () async => await notesProvider.archiveNotes(ids),
  ...
  Widget build(BuildContext context) {
    ...
    // Desktop/Tablet/Foldable — نمط version_history
              ...
              children: [
                ...
                Expanded(
                  child: MasterDetailsLayout(
                    ...
                    masterPanel: _buildNotesList(archivedNotes, l10n),
  ...
  Widget _buildNotesList(List<Note> archivedNotes, AppLocalizations l10n) {
